...
export const RUNTIME_ENV_DEFINITIONS = [
  ...
  runtimeEnvDefinition("MODAL_TOKEN_ID", "Modal token ID", "runpod", "Platform-managed Modal service-user token ID for GPU inference.", reservedInjectable),
  runtimeEnvDefinition("MODAL_TOKEN_SECRET", "Modal token secret", "runpod", "Platform-managed Modal service-user token secret for GPU inference.", reservedInjectable),
  runtimeEnvDefinition("ABRA_REMOTE_GPU_PROVIDER", "Remote GPU provider", "runpod", "Platform-selected remote GPU provider (modal or runpod).", reservedInjectableNonSecret),
  runtimeEnvDefinition("BACKBLAZE_B2_REMOTE_KEY_ID", "Backblaze B2 remote key ID", "runpod", "Backblaze B2 application key ID used by remote GPU staging.", reservedInjectableNonSecret),
  runtimeEnvDefinition("BACKBLAZE_B2_REMOTE_APPLICATION_KEY", "Backblaze B2 remote application key", "runpod", "Backblaze B2 application key used by remote GPU staging.", reservedInjectable),
  runtimeEnvDefinition("BACKBLAZE_B2_REMOTE_BUCKET_NAME", "Backblaze B2 remote bucket", "runpod", "Backblaze B2 bucket used by remote GPU staging.", reservedInjectableNonSecret),
