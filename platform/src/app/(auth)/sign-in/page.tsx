      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
        ...
        <div className="flex w-full flex-col gap-3">
          <form action={signInWithGoogle} className="w-full">
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-border-subtle bg-white px-4 py-3 text-body font-semibold text-content-100 shadow-card hover:shadow-panel hover:scale-[1.01] active:scale-[0.99] transition-all duration-150 ease-smooth focus-ring-brand"
            >
          ...
          <form action={signInWithGitHub} className="w-full">
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-gray-900 px-4 py-3 text-body font-semibold text-white shadow-card hover:shadow-panel hover:scale-[1.01] active:scale-[0.99] transition-all duration-150 ease-smooth focus-ring-brand"
            >
...
async function ErrorBanner({
  ...
  const description =
    error === "missing_oauth_code"
      ...
      : "We could not complete the OAuth sign-in exchange. Please try again.";
