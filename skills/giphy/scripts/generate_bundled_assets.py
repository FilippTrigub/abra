#!/usr/bin/env python3
"""
generate_bundled_assets.py — Generate placeholder GIF animations for the giphy skill.
...
Run once after cloning:
    cd skills/giphy && uv run python scripts/generate_bundled_assets.py

For sounds, add local/bundled SFX files under assets/sfx/ or assets/sfx/library/.
"""
...
if __name__ == "__main__":
    ...
    print("For sounds:        add files to assets/sfx/ or assets/sfx/library/")
