"""assets.py — Asset resolution and favourites management for the sticker skill.

Handles bundled assets, GIPHY API, Freesound API, and a persistent
